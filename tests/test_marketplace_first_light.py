...
'''
    ...
    def test_absent_and_mismatched_runtime_are_explicit_lifecycle_gates(self):
        ...
        self.assertEqual(
            ...
            "ready")
        self.assertEqual(
            self._model_lifecycle({"version": "1.6.0"}, RELEASE_VERSION),
            "ahead")
        self.assertEqual(
        ...
        self.assertEqual(
            self._model_call(
                "guidedLifecycle", {"version": "1.6.0"}, installing,
                RELEASE_VERSION),
            "ahead")
        newer_ready = {"v": 1, "version": "1.6.0", "state": "ready"}
        self.assertEqual(
            self._model_call(
